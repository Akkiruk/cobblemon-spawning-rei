...
class JeiSpawnCategory(guiHelper: IGuiHelper) : IRecipeCategory<JeiSpawnRecipe> {
    ...
    companion object {
        val RECIPE_TYPE: RecipeType<JeiSpawnRecipe> = RecipeType(
            ResourceLocation.fromNamespaceAndPath(CobbleDexMod.MOD_ID, "jei_spawns"),
    ...
    override fun getTitle(): Component = Component.translatable("category.cobbledex-rei-emi-jei.spawn")
